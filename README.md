...
- 2026.09.20
- Synchronized ecosystem baseline with `stvnadore-core:1.3.1`
...
- Zero-copy binary Strategy `0x07` with CRC-32C trailer verified
- FIDE engine rule isomorphism confirmed across full test harness
